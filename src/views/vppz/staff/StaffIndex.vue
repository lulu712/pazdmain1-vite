<template>
  <div class="page">
    <div class="shell">
      ...
      <div class="content-card companion-card">
          ...
          <div class="table-wrap">
            ...
            >
              ...
              <el-table-column prop="name" label="名稱" min-width="80" />
              ...
              <el-table-column prop="mobile" label="手機號碼" min-width="110" />
...
<script setup>
import {Plus,Clock, InfoFilled, Delete }from '@element-plus/icons-vue';
